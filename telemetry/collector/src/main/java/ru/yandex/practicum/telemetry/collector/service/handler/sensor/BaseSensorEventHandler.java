...
public abstract class BaseSensorEventHandler<T extends SpecificRecordBase> implements SensorEventHandler {
    ...
    public void handle(SensorEvent event) {
        log.info("Processing SensorEvent {}: id={}, hubId={}, timestamp={}", event.getType(), event.getId(),
                event.getHubId(), event.getTimestamp());
        log.debug("SensorEvent {}: {}", event.getType(), event);
        ...
        log.info("Sending SensorEvent {} id={}, hubId={}, timestamp={} to topic {}", event.getType(), event.getId(),
